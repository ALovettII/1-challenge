...
print(f"Months remaining on loan: {remaining_months} months")
...
discount_rate = .20
present_value = future_value / (1 + discount_rate/remaining_months)**(remaining_months)
...
if present_value >= loan_price:
    print(f"Price of loan: ${loan_price}; Fair value: ${present_value: .2f}; The loan is worth at least the cost to buy.")
else:
    print(f"Price of loan: ${loan_price}; Fair value: ${present_value: .2f}; The loan is too expensive, thus, not worth the price.")
...
def calc_pv(future_value, remaining_months, annual_discount_rate):
    present_value = future_value / (1 + annual_discount_rate/remaining_months)**(remaining_months)
...
# @TODO: Create an empty list called `inexpensive_loans`x
inexpensive_loans = []
